...
➖➖➖➖ا➖➖➖➖]]
			...
			elseif text:match("^(!bc)(.*) (.*)") then
				...
				elseif matches[1] == "pv" then
					kia = "selfbotBOT-IDusers"
				elseif matches[1] == "gp" then
					kia = "selfbotBOT-IDgroups"
				elseif matches[1] == "sgp" then
					kia = "selfbotBOT-IDsupergroups"
				else 
					return false
				end
				local list = redis:smembers(kia)
				for i=1, #list do
